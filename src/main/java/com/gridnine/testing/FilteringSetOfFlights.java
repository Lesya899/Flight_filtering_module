...
public class FilteringSetOfFlights implements Filter {
    @Override
    public void showFlights(List<Flight> fls) {
    ...
    @Override
    public List<Flight> ArrivalDateBeforeDepartureDate(List<Flight> fls) {
    ...
    @Override
    public List<Flight> FlightTotalTimeMoreTwoHours(List<Flight> fls) {
